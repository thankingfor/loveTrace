...
<div class="hope">
  <ul>
    <div class="visitors">
      <dl>
        <dt><img src="${pageContext.request.contextPath}/static/images/old/s6.jpg"> </dt>
        <dd><a href="#">DanceSmile</a> </dd>
        <dd>你们本就是天生一对，地造一双，而今共偕连理，今后更需彼此宽容、互相照顾，祝福你们！</dd>
      </dl>
      <dl>
        <dt><img src="${pageContext.request.contextPath}/static/images/old/s7.jpg"> </dt>
        <dd><a href="#">骄傲的小甜甜</a> </dd>
        <dd>十年修得同船渡，百年修得共枕眠。于茫茫人海中找到她，分明是千年前的一段缘，祝你俩幸福美满，共谐连理。</dd>
      </dl>
      <dl>
        <dt><img src="${pageContext.request.contextPath}/static/images/old/s8.jpg"> </dt>
        <dd><a href="#">执子之手</a> </dd>
