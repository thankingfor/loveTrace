...
<header>
  <div class="quotes">
    ...
    <div class="text5">小言·静静</div>
    <div class="flower"><img src="${pageContext.request.contextPath}/static/images/old/flower.jpg"></div>
  </div>
  <!--nav begin-->
  <div id="nav">
    <ul>
      <li><a href="index">首页</a></li>
      <li><a href="suiyan">碎言碎语</a></li>
      <li><a href="manman">慢生活</a></li>
      <li><a href="yongyong">回忆相册</a></li>
      <li><a href="article">文章记忆</a></li>
      <li><a href="biaobai">相爱相守</a></li>
   	</ul>
  </div>
  <!--nav end--> 
</header>